...
public class GlossaryTest {
    ...
    /*
     * Includes test units for methods in Glossary. In addition, some of
    ...
    public void getDictionaryTest1() {
        ...
        outputExpected.add(
                ...
                "thing");
        Map<String, String> output = Glossary
    ...
    public void createMapTest1() {
        ...
        Map<String, String> output = Glossary.createMap(input);
        Map<String, String> outputExpected = new Map1L<>();
    ...
    public void removeMinTest1() {
        ...
        Map.Pair<String, String> output = Glossary.removeMin(input);
