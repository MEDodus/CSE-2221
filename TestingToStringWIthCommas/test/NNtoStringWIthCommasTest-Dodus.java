...
public class NNtoStringWIthCommasTest {
    ...
    /*
     * Routine case: Nothing funky about how the computer should think about
     * this one.
     */
    @Test
    public void toStringWithCommasTest1() {
        NaturalNumber n = new NaturalNumber2("1234567891011");
        String nToString = redirectToMethodUnderTest(n);
        String nExpected = "1,234,567,891,011";
