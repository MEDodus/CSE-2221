...
public final class RSSReader {
    ...
    private static void outputHeader(XMLTree channel, SimpleWriter out) {
        ...
        if (descriptionChildren == foreverAlone) {
        ...
        // If RSS validate no need to check precondition for itme existing
    ...
    private static void processItem(XMLTree item, SimpleWriter out) {
        ...
        // Index to start loops at
        final int start = 0;
        // Child zero
        final int zero = 0;

        // Children we need to search for
        // Probably no need to make Strings for them since the variable names
        // are the same as the object values but it's there for organization.
    ...
    public static void main(String[] args) {
        ...
        out.print("Enter an rss-xml document to be read (include \".xml\" "
                + "extension): ");
        String xmlInput = in.nextLine();
        out.print("Enter the name of the output html file with \".html\" "
                + "extension included: ");
        String htmlInput = in.nextLine();

        // Initializes HTML file output stream and XML file
        xml = new XMLTree1(xmlInput);
        html = new SimpleWriter1L(htmlInput);
        ...
        /*
         * Program looks kinda gross PrintWriter isn't good for printing html
         * documents or I'm just not using it well.
         */
        in.close();
        out.close();
        html.close();
