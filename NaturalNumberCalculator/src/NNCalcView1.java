...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
         ...
         */
        // Default initially disable root and divide widgets.
         ...
         */
        // Create a scroll pane for top text area.
        JScrollPane sTop = new JScrollPane(this.tTop);
        // Create a scroll pane for bottom text area.
        JScrollPane sBottom = new JScrollPane(this.tBottom);
         ...
         * to bottom
         */
        // Adds all buttons in correct order.
        ...
        // Create listeners for all bDigits buttons
        for (int i = 0; i < this.bDigits.length; i++) {
    ...
    public void updateTopDisplay(NaturalNumber n) {
        // Use toString() to set top text to the NN ov
        this.tTop.setText(n.toString());
    }

    @Override
    public void updateBottomDisplay(NaturalNumber n) {
        // Use toString() to set bottom text to the NN ov
        this.tBottom.setText(n.toString());
    }

    /*
     * All *allowed* methods check whether the condition is true or false and
     * enable or disable the widget in accordance to the boolean value.
     */
