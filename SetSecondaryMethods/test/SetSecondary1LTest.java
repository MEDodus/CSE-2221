...
public final class SetSecondary1LTest {
    ...
    @Test
    public final void testIsSubset1() {
        Set<String> s1 = createFromArgs("1", "4", "7");
        Set<String> s1Expected = createFromArgs("1", "4", "7");
        Set<String> s2 = createFromArgs("1", "2", "3", "4", "5", "6", "7");
        Set<String> s2Expected = createFromArgs("1", "2", "3", "4", "5", "6",
                "7");
        boolean isSubset = s1.isSubset(s2);
        assertEquals(s1Expected, s1);
        assertEquals(s2Expected, s2);
    ...
    @Test
    public final void testIsSubset2() {
        Set<String> s1 = createFromArgs("1", "4", "7", "8", "-1");
        Set<String> s1Expected = createFromArgs("1", "4", "7", "8", "-1");
        Set<String> s2 = createFromArgs("1", "2", "3", "4", "5", "6", "7");
        Set<String> s2Expected = createFromArgs("1", "2", "3", "4", "5", "6",
                "7");
        boolean isSubset = s1.isSubset(s2);
